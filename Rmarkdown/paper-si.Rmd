...
Pipes extracted at the other two sites 2--3 had similar corrosion scale to that of site 1 (Figure 3b--c, respectively). A pyromorphite mineral was present, although the match to chloropyromorphite was evenless certain here than in the XRD patterns representing site 1. XRD patterns also matched the lead carbonates hydrocerussite (sites 2--3) and cerussite (site 2), as well as the lead oxide litharge (site 3). 
